...
import os
# from models.improvedSMNet2 import lowlightnet_ACM
from models.FFNet import lowlightnet_ACM
def eval(opt):
    ...
    # Load model
    model = lowlightnet_ACM(input_dim=3, dim=[16, 32, 64, 128])
    # model = lowlightnet3()
    ...
    if str.lower(opt.modeltype) == 'fivek':
        ...
        pass
    model.load_state_dict(torch.load(opt.modelfile, map_location='cuda:0'))
    model.eval()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--test_folder', type=str, default=r'E:\project\py-project\imageEnhancement\SMNet-main\datasets\test2',help='location to input images')
    ...
    parser.add_argument('--modelfile', default='./models/best-synthetic-24.22-92.6.pth', help='pretrained model LOL or FIVEK')
